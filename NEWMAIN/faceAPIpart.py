...
class faceAPIpart:
    ...
    KEY = '658401429abb40dfb56919023fa87da6'
    #エンドポイントURLの設定
    #ENDPOINT = 'https://miyakenewface.cognitiveservices.azure.com/'(無料分)
    ENDPOINT = 'https://notfreeface.cognitiveservices.azure.com/'
    ##初期設定
